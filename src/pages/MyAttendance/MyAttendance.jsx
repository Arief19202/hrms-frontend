...
function MyAttendance() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-lg p-6 text-white flex flex-col md:flex-row justify-between items-center gap-4">
        <div>
          ...
          <div className="mt-2 flex items-center gap-2 bg-white/20 px-3 py-1 rounded-lg w-fit text-xs font-medium">
            <span>🏢 Company Operating Hours:</span>
            <span className="font-bold text-yellow-300">8:00 AM – 5:00 PM</span>
          </div>
        </div>
        <div className="bg-white/10 backdrop-blur-md px-6 py-3 rounded-xl text-center border border-white/20">
      ...
      <div className="bg-white rounded-xl shadow p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-rose-50 border border-rose-200 rounded-xl p-6 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-3xl font-mono font-bold text-rose-700">
        ...
        <div className="flex gap-4 mt-8">
          ...
          <button
            ...
            className={`px-8 py-3.5 rounded-xl font-semibold transition-all shadow-md ${
              attendance?.check_in
              ...
              {history.length === 0 ? (
                ...
                history.map((record) => (
                  <tr key={record.id} className="border-b hover:bg-gray-50 text-sm">
                    ...
                    <td className="py-3 px-4 text-rose-700 font-mono">
